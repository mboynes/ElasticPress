...
class WooCommerce extends Feature {
	...
	public function blacklist_coupons( $enabled, $query ) {
		if ( method_exists( $query, 'get' ) && 'shop_coupon' === $query->get( 'post_type' ) && empty( $query->query_vars['ep_integrate'] ) ) {
			return false;
		}
	...
	public function setup() {
		...
		add_filter( 'ep_elasticpress_enabled', [ $this, 'blacklist_coupons' ], 15, 2 );
